...
The tablet package is a delivery follower. Tablet execution cannot close the PowerVR-phone hardware gate.
...
1. exact-head GitHub CI proves that the checked Idris source regenerates the tracked shader fragments without differences and that the software harness works under Mesa;
